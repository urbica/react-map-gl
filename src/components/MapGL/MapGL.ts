...
// export type Children = React.ChildrenArray<Element<any>>;
type MapboxMapProps = Omit<MapboxOptions, 'container' | 'style'>;
...
export type Props = React.PropsWithChildren<MapboxMapProps & ComponentProps>;
...
// /* A string representing the position of the
// Mapbox wordmark on the map. */
...
//      * This setting does not affect the duration of runtime styling
